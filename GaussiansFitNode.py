...
class GaussiansFitNode(mdp.Node):
	def is_trainable(self):
		return False

	def _gauss_creator_simple(self, num_of_gauss):
		"""
	...
	def _gauss_creator_complex(self, num_of_gauss, num_of_variables):
		"""
		Higher order function that returns a gaussian curve function 
		with the number of gaussians specified
	...
	def _gauss_creator_minimal(self, num_gauss, num_vars, amps, sigmas):
		"""
	...
	def _smooth_gaussians(self, data, sigmas, order=0):
		"""
	...
	def _get_zero_crossings(input_data, output_data):
		"""
	...
	def _to_scale_space(x,y, start_sigma = 1, sigma_step = 1):
		"""
		Input: 
	...
	def _to_arc_space(self, zeros, sigmas):
		"""
	...
	def _find_closest_crossing(self, val, zeros):
		"""
	...
	def _find_pairs(self, pairs, zeros, singles, input_data, convolved_1):
		"""
	...
	def _label_arches(self, zero_crossings, input_data, convolved_1):
		"""
	...
	def _estimate_means(self, arches):
		"""
	...
	def _estimate_sigmas(self, arches):
		"""
	...
	def _estimate_amplitudes(self, input_data, output_data, means, sigmas):
		num_gauss = len(means)
	...
	def _estimate_num_gauss(self, arches, tol, input_data, output_data):
		"""
	...
	def _estimate_mean_coeffs(self, means):
		"""
	...
	def _graph_scale(self, x, blurred, first, second, sigmas):
		plt.figure()
		for i in range(len(sigmas)):
			if i % 8 == 0:
	...
	def _graph(self, input_data, output_data, convolved_2, arc_data):
		plt.figure(1)
		plt.subplot(221)
	...
	def _execute(self, input_data, output_data):
		"""
